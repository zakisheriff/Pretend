...
interface OnlineGameState {
    ...
    broadcastSelection: (selection: { type: 'mode' | 'player' | 'movie' | 'timer' | 'PICTIONARY_OPTIONS' | 'PICTIONARY_TIMER' | 'PICTIONARY_WORD_SELECTED' | 'PICTIONARY_GUESS' | 'themes' | 'hint_level', id: string | null, data?: any } | null) => Promise<void>;
    selection: { type: 'mode' | 'player' | 'movie' | 'timer' | 'PICTIONARY_OPTIONS' | 'PICTIONARY_TIMER' | 'PICTIONARY_WORD_SELECTED' | 'PICTIONARY_GUESS' | 'themes' | 'hint_level', id: string | null, data?: any } | null;
